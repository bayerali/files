      ...
      <main className="main dashboard-layout">
        ...
        <section className="dashboard-grid">
          <article className="card">
            ...
            <div style={{ marginTop: 16 }}>
              ...
              {selectedParent && firstLevelChildren.length > 0 ? (
                ...
                <div className="card empty">Keine Unterbereiche für diesen Bereich definiert.</div>
              ) : null}
            </div>
          </article>
          ...
          <article className="card">
            ...
            {selectedChildId === null ? (
              ...
              <div className="card empty">Keine Aufgaben für diesen Unterbereich definiert.</div>
            ) : (
              <div className="shift-list">
                {visibleTasks.map((task) => {
                  ...
                  return (
                    <div key={task.id} className="shift-card">
        ...
        <section className="card">
          ...
          <div className="parent-list" style={{ marginTop: 12 }}>
            <button className="btn-primary" onClick={() => addShiftNote("handover")}>
              Als Übergabe speichern
            </button>
            <button className="btn-ghost" onClick={() => addShiftNote("warning")}>
              Als Warnung speichern
            </button>
            <button className="btn-ghost" onClick={() => addShiftNote("info")}>
              Als Info speichern
            </button>
          </div>
          ...
          <div className="shift-list" style={{ marginTop: 16 }}>
            {shift.notes.length === 0 ? (
              <div className="card empty">Noch keine Übergaben oder Meldungen erfasst.</div>
            ) : (
              [...shift.notes]
                .sort((a, b) => b.createdAt - a.createdAt)
                .map((note) => (
                  <div key={note.id} className="shift-card">
                    <div className="shift-meta">
                      ...
                      <div className="shift-sub">{formatTimestamp(note.createdAt)}</div>
